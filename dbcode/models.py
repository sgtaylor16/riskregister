...
class Persons(db.Model):
    ...
    risks: Mapped[List["Risks"]] = relationship("Risks",back_populates="person")
...
class Risks(db.Model):
    ...
    person: Mapped['Persons'] = relationship("Persons",back_populates="risks")
    program_id: Mapped[int] = Column(ForeignKey('programs.id'))
    program: Mapped["Programs"] = relationship("Programs",back_populates="risks")
    mitigations: Mapped[List["Mitigations"]] = relationship("Mitigations",back_populates="risk")
...
class Mitigations(db.Model):
    ...
    risk: Mapped['Risks'] = relationship("Risks",back_populates="mitigations")
    date: Mapped[datetime] = Column(DateTime)
    complete: Mapped[int] = Column(Integer,default=0)
...
class Programs(db.Model):
    ...
    risks: Mapped[List["Risks"]] = relationship("Risks",back_populates="program")
